...
window.title("FSDI 111 BILLING PROJECT")
...
def loginWindow():
    titleLabel = Label(window,text="FSDI111 Billing System",font="Arial 40",fg="pink")
...
def mainwindow():
    ...
    titleLabel = Label(window,text="FSDI111 Billing System",font="Arial 30",fg="pink")
...
def itemAddWindow():
    ...
    titleLabel = Label(window,text="FSDI11 Billing System", width=40,font="Arial 30",fg="pink")
...
def updateItemWindow():
    backButton = Button(window, text="Back" , command=lambda:readAllData())
    backButton.grid(row=0, column=1)
    titleLabel = Label(window,text="FSDI111 Billing System", width=40,font="Arial 30",fg="pink")
    titleLabel.grid(row=0,column=2,columnspan=4,pady=(10,0))
